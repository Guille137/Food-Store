...
| Informes | Documentar resultados observados, limitaciones, decisiones e instrucciones de reproducción. | Se conservan tiempos reales, limitaciones de caché y costo de índices. | Los informes enlazan a las evidencias de PostgreSQL. |
